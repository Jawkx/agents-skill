...
3. **Navigate to it.** Drive the app (`device-interaction.md`) to the screen where the element is visible — a screenshot is only meaningful if the element is actually on screen.
